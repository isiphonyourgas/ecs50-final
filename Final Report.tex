...
More broadly, the number of jumps in the functions of the optimized code reduced in comparison to the unoptimized code. This allowed, in some cases, the elimination of a counter, such as the instance with the "for" loop. The optimized code also reduced memory access through the use of registers. Through the analysis of the optimized and unoptimized file, the changes in order, number of jumps, and implementation of saftey attributes causes the optimized file to be more efficient in comparison with the unoptimized file.
\appendix .
\appendixpage
