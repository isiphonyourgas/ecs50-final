...
Many of the instructions that follow 
...
main:
   ...
   je      .L20
\end{verbatim}
A jump is made if there are only two arguments. Otherwise, .L18, the instruction 
after {\bf main()} which performs necessary stack operations, returns. It is extremely minimalist, and nothing else is performed 
